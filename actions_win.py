...
# actions_win.py
# The Windows action catalog: everything a control can be set to do on Windows.
#
...
#
# actions.py picks this or actions_mac.py and presents whichever it got. Action ids are
# stored in mappings.json, so renaming one silently breaks a mapping someone made.
